...
WHERE
  ...
  INSERT INTO H_Accounting.rkapoor_tmp 
	...
	INSERT INTO H_Accounting.rkapoor_tmp
			(balance_sheet_line_number, label, amount, Percentage_change)
	VALUES 	(3, 'Current Assets', format(varCurrentAssets1 / 1000, 2), format((varCurrentAssets1-varCurrentAssets2)/varCurrentAssets2,2)),
    (4, 'Fixed Assets', format(varFixedAssets1 / 1000, 2),format((varFixedAssets1-varFixedAssets2)/varFixedAssets2,2)),
    (5, 'Deferred Assets', format(varDeferredAssets1 / 1000, 2),format((varDeferredAssets1-varDeferredAssets2)/varDeferredAssets2,2)),
    (5, 'Total Assets', format((varCurrentAssets1 + varFixedAssets1 + varDeferredAssets1) / 1000, 2),
    ...
    (6, '', '',''),
    (7, 'Current Liabilities', format(varCurrentLiabilities1 / 1000, 2),
    format((varCurrentLiabilities1-varCurrentLiabilities2)/varCurrentLiabilities2,2)),
    (8, 'Long Term Liabilities', format(varLongTermLiabilities1 / 1000, 2),
    format((varLongTermLiabilities1-varLongTermLiabilities2)/varLongTermLiabilities2,2)),
    (9, 'Deferred Liabilities', format(varDeferredLiabilities1 / 1000, 2),format((varDeferredLiabilities1-varDeferredLiabilities2)/varDeferredLiabilities2,2)),
    (10, 'Total Liabilities', format((varCurrentLiabilities1 + varLongTermLiabilities1 + varDeferredLiabilities1) / 1000, 2),
    ...
    (11, '', '',''),
	(12, 'Equity', format(varEquity1 / 1000, 2),format((varEquity1-varEquity2)/varEquity2,2)),
	(13, '', '',''),
